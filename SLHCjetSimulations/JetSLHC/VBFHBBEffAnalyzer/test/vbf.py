...
process.load("JetSLHC.VBFHBBEffAnalyzer.vbfhbbeffanalyzer_cfi")
process.vbfHBBEffAnalyzer.JetsFromVBF = cms.bool(True)
process.vbfHBBEffAnalyzer.JetsFromHiggsDecay = cms.bool(False)
...
process.source = cms.Source ("PoolSource",
   ...
   fileNames = cms.untracked.vstring(
     'file:/data/pioppi/work/SLHC/SIGNAL/src/VBFHGG.root'
   ),
