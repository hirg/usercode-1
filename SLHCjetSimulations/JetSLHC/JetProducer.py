...
#Refer to these in the analyzer
#process.demo = cms.EDAnalyzer('Simple',
process.demo = cms.EDAnalyzer('L1JetAnalyzer',
  ...
  #Jet corrector for calo jets
  JetCorrectorl2l3res = cms.string('ak5CaloL1FastL2L3Residual'),#test
  JetCorrector = cms.string('ak5CaloL1FastL2L3'), 
#JetCorrectorPF = cms.string('ak5PFL1FastL2L3'),
